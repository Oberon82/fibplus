...
begin
  ...
  begin
    tmpAttachment := TFb25Attachment.Create(FClientLibrary, db_handle) as IFb25Attachment;
...
begin
  ...
  if not AStatus.HasErrors then
  begin
    Result := TFb25Attachment.Create(FClientLibrary, db_handle) as IFbAttachment;
  end;
end;
